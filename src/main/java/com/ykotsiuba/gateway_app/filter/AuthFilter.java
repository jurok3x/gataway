package com.ykotsiuba.gateway_app.filter;

import com.ykotsiuba.gateway_app.service.SessionService;
import com.ykotsiuba.gateway_app.service.impl.GoogleOauthService;
...
public class AuthFilter implements GlobalFilter, Ordered {
    ...
    public static final String REDIRECT_LOCATION = "/api/v1/profile";
    ...
    private Mono<Void> authCallback(ServerWebExchange exchange) {
        ...
        return verifyState(state, exchange.getRequest())
                .then(googleAuthenticationService.processAuthenticationCallback(code, redirectUri)
                        ...
                        .then(sendRedirect(exchange, REDIRECT_LOCATION)));
    }
